...
+ (NSString *)changeMultipleCodeFileName:(NSString *)path{
    NSString *strTemp=[NSString stringWithContentsOfFile:@"/Users/mac/Desktop/代码助手.m" encoding:NSUTF8StringEncoding error:nil];
...
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@ViewController\"",fileName,[fileName substringToIndex:fileName.length-@"ViewController".length]];
//    }else if ([lowercaseString hasSuffix:@"tableviewcell"]){
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@TableViewCell\"",fileName,[fileName substringToIndex:fileName.length-@"TableViewCell".length]];
//    }else if ([lowercaseString hasSuffix:@"collectionviewcell"]){
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@CollectionViewCell\"",fileName,[fileName substringToIndex:fileName.length-@"CollectionViewCell".length]];
//    }else if ([lowercaseString hasSuffix:@"cell"]){
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@Cell\"",fileName,[fileName substringToIndex:fileName.length-@"Cell".length]];
//    }else if ([lowercaseString hasSuffix:@"cellmodel"]){
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@CellModel\"",fileName,[fileName substringToIndex:fileName.length-@"CellModel".length]];
//    }else if ([lowercaseString hasSuffix:@"model"]){
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@Model\"",fileName,[fileName substringToIndex:fileName.length-@"Model".length]];
//    }else{
//        return [NSString stringWithFormat:@"    \"%@\":\"ZHANGHUAN%@\"",fileName,fileName];
//    }
//}
...
+ (NSString *)getOldNameAndSetNewName:(NSString *)fileName{
    NSString *lowercaseString=[fileName lowercaseString];
    if ([lowercaseString hasSuffix:@"viewcontroller"]) {
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>ViewController\"",fileName,[fileName substringToIndex:fileName.length-@"ViewController".length]];
    }else if ([lowercaseString hasSuffix:@"tableviewcell"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>TableViewCell\"",fileName,[fileName substringToIndex:fileName.length-@"TableViewCell".length]];
    }else if ([lowercaseString hasSuffix:@"collectionviewcell"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>CollectionViewCell\"",fileName,[fileName substringToIndex:fileName.length-@"CollectionViewCell".length]];
    }else if ([lowercaseString hasSuffix:@"cell"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>Cell\"",fileName,[fileName substringToIndex:fileName.length-@"Cell".length]];
    }else if ([lowercaseString hasSuffix:@"cellmodel"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>CellModel\"",fileName,[fileName substringToIndex:fileName.length-@"CellModel".length]];
    }else if ([lowercaseString hasSuffix:@"model"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>Model\"",fileName,[fileName substringToIndex:fileName.length-@"Model".length]];
    }else if ([lowercaseString hasSuffix:@"model"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>Delegate\"",fileName,[fileName substringToIndex:fileName.length-@"Delegate".length]];
    }else if ([lowercaseString hasSuffix:@"model"]){
        return [NSString stringWithFormat:@"    \"%@\":\"<#%@#>Manager\"",fileName,[fileName substringToIndex:fileName.length-@"Manager".length]];
    }else{
